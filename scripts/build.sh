...
swiftc -O \
    "$ROOT/app/AppDelegate.swift" "$ROOT/app/main.swift" "$ROOT/app/PanelView.swift" "$ROOT/app/TempMonitor.swift" "$ROOT/app/Format.swift" "$ROOT/app/DailyLog.swift" "$ROOT/app/ProcMonitor.swift" "$ROOT/app/Cleaner.swift" "$ROOT/app/PopoverPolicy.swift" \
